...
const GallerySection = () => {
  ...
  return (
    <section id="gallery" className="py-16 bg-white overflow-hidden w-full">
      <div className="container px-4">
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4 max-w-6xl mx-auto w-full px-4">
          {siteConfig.galleryImages.map((src, idx) => (
            <motion.div
              key={idx}
